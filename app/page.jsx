  ...
  return (
    <>
      ...
      <main className="sub-wrap">
        ...
        {/* RELATED */}
        <div className="sub-card">
          <p className="sub-section-title">Related tools</p>
          <div className="sub-related-links">
            {RELATED.map((r, i) => (
              <a key={i} className="sub-related-link" href={r.href}>{r.label}</a>
            ))}
          </div>
          <div className="sub-disclaimer">
            This tool performs calculations locally in your browser. No data is stored or transmitted. Investment projections are illustrative only and do not guarantee future returns. Actual investment results will vary. This site may use cookies and analytics. By using this site, you agree to our Privacy Policy and Terms of Service.
